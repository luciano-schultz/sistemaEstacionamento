 ...
 */
class Estacionamento extends \Admin\Entity\Estacionamento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Admin\\Entity\\Estacionamento' . "\0" . 'id', '' . "\0" . 'Admin\\Entity\\Estacionamento' . "\0" . 'endereco', '' . "\0" . 'Admin\\Entity\\Estacionamento' . "\0" . 'bairro', '' . "\0" . 'Admin\\Entity\\Estacionamento' . "\0" . 'cidade', '' . "\0" . 'Admin\\Entity\\Estacionamento' . "\0" . 'estado');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Estacionamento $proxy) {
