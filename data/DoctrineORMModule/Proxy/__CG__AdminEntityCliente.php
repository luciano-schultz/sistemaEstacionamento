 ...
 */
class Cliente extends \Admin\Entity\Cliente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Admin\\Entity\\Cliente' . "\0" . 'id', '' . "\0" . 'Admin\\Entity\\Cliente' . "\0" . 'nome', '' . "\0" . 'Admin\\Entity\\Cliente' . "\0" . 'cpf', '' . "\0" . 'Admin\\Entity\\Cliente' . "\0" . 'cnh', '' . "\0" . 'Admin\\Entity\\Cliente' . "\0" . 'endereco', '' . "\0" . 'Admin\\Entity\\Cliente' . "\0" . 'bairro', '' . "\0" . 'Admin\\Entity\\Cliente' . "\0" . 'cep', '' . "\0" . 'Admin\\Entity\\Cliente' . "\0" . 'cidade', '' . "\0" . 'Admin\\Entity\\Cliente' . "\0" . 'estado', '' . "\0" . 'Admin\\Entity\\Cliente' . "\0" . 'telefone');
        }
