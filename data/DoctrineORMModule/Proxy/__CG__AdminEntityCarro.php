 ...
 */
class Carro extends \Admin\Entity\Carro implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Admin\\Entity\\Carro' . "\0" . 'id', '' . "\0" . 'Admin\\Entity\\Carro' . "\0" . 'placa', '' . "\0" . 'Admin\\Entity\\Carro' . "\0" . 'modelo', '' . "\0" . 'Admin\\Entity\\Carro' . "\0" . 'cor', '' . "\0" . 'Admin\\Entity\\Carro' . "\0" . 'cliente');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Carro $proxy) {
