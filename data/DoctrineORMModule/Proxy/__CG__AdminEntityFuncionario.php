 ...
 */
class Funcionario extends \Admin\Entity\Funcionario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Admin\\Entity\\Funcionario' . "\0" . 'id', '' . "\0" . 'Admin\\Entity\\Funcionario' . "\0" . 'nome', '' . "\0" . 'Admin\\Entity\\Funcionario' . "\0" . 'cpf', '' . "\0" . 'Admin\\Entity\\Funcionario' . "\0" . 'telefone', '' . "\0" . 'Admin\\Entity\\Funcionario' . "\0" . 'endereco', '' . "\0" . 'Admin\\Entity\\Funcionario' . "\0" . 'cargo', '' . "\0" . 'Admin\\Entity\\Funcionario' . "\0" . 'login');
        }
