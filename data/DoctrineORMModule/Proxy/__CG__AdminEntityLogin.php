 ...
 */
class Login extends \Admin\Entity\Login implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Admin\\Entity\\Login' . "\0" . 'id', '' . "\0" . 'Admin\\Entity\\Login' . "\0" . 'nome', '' . "\0" . 'Admin\\Entity\\Login' . "\0" . 'email', '' . "\0" . 'Admin\\Entity\\Login' . "\0" . 'senha');
        }
